---
title: 'Summarizing a Series of Variables'
...
With the agencies data, produce a *meaningful* summary of the following variables: 

- The average number of launches
- The median of the number of launches
- The variance of the number of launches
- A count of the unique number of agencies. (In the lecture, I wrote a method of accomplishing this using base tools; you can also use the `dplyr` function `n_distinct`)
