---
Title: 'Make Scatter Plots Solution'
...
This output is best viewed over in github because we cannot render images into
the ISVC. :tada:
...
- Notice that this now *is* an attribute of the data. So, where should the `color` argument go?
